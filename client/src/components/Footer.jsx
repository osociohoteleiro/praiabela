        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Seu refúgio paradisíaco em Ilhéus, Bahia. Conforto, natureza e hospitalidade.
            </p>
            {siteInfo && (
          ...
          <div>
            ...
            <ul className="space-y-2">
              {['Início', 'Sobre', 'Acomodações', 'Pacotes', 'Galeria', 'Contato'].map((link) => (
                <li key={link}>
                  <a
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">Siga-nos e fique por dentro das novidades!</p>
            <div className="flex gap-4">
              ...
              {siteInfo?.instagram_url && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 bg-gray-800 hover:bg-gradient-to-r hover:from-purple-500 hover:to-pink-500 rounded-full flex items-center justify-center transition-all"
                >
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
